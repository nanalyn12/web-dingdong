...
REVOKE EXECUTE ON FUNCTION public.is_editor(uuid) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.has_role(uuid, public.app_role) TO authenticator;
GRANT EXECUTE ON FUNCTION public.is_editor(uuid) TO authenticator;