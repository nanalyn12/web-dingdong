...
export const STYLE_PRESETS: {
  ...
  { value: "traditional chinese, guzheng, modern fusion", label: "🏮 전통 퓨전", genre: "traditional" },
];
...
export function genreFromStyle(
...
const THEME_HINTS: [RegExp, SongTheme][] = [
  ...
  [/사랑|연애|고백|이별|그리|마음|설레|위로|위안|운명|숙명|愛|爱|恋|喜欢|心|温柔|慰藉|宿命/i, "love"],
  ...
  [/일상|생활|카페|아침|점심|오후|저녁|주말|수다|산책|나른|집|日常|生活|咖啡|散步|聊天|下午|慵懒/i, "daily"],
];

/** 작사 키워드와 제목을 합쳐 주제를 고른다. `theme` 컬럼이 비어 있는 옛 곡도
 * 읽는 시점에 채워지므로 백필이 필요 없다. */
export function themeFromKeywords(
